            ...
            <div class="modal-content bg-white border-0">
              ...
              <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#">Tes Kepribadian</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('graduation.index') }}">Prediksi Kelulusan</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">Tema Paper?</a>
                  </li>
                  <li class="nav-item">
            ...
            @if (Route::has('login'))
                @auth
                    <form action="{{ route('logout') }}" method="post">
                        @csrf
                        <button class="btn btn-default btn-no-fill" type="submit">Logout</button>
                    </form>
                @else
                        <a class="btn btn-default btn-no-fill" href="{{ route('login') }}">Login</a>
                    @if (Route::has('register'))
                        <a class="btn btn-fill text-white" href="{{ route('register') }}">Register</a>
                    @endif
                @endauth
            @endif
          </div>
